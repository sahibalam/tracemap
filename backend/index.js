...
// ============================================
// 🛣️ Routes - FIXED MOUNTING
// ============================================

// 🔐 Auth Routes - Mount at /api (not /api/auth)
app.use("/api", authRoutes);  // ✅ Fixed: Now /api/auth/register works
...
app.listen(PORT, () => {
  ...
  console.log(`   POST /api/auth/register`);        // ✅ Now works!
  console.log(`   POST /api/auth/login`);           // ✅ Now works!
