...
import { 
  ...
  deleteWorkerProfile,
  getWorkerByEmail,
  checkPhoneAvailability, // ✅ NEW: Import phone availability check
  getAllWorkers,
  getWorkerAvailability,
  getWorkerTrade,
  getWorkerCertifications,
...
/**
 * ✅ GET /api/worker/phone/:phone
 * Check if phone number is available (not already registered)
 */
router.get('/phone/:phone', checkPhoneAvailability)
