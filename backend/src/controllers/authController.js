...
export const login = async (req, res) => {
  try {
    ...
    const userLanguage = user.profile?.basics?.language || 'en'
    ...
    res.json({
      ...
      data: {
        ...
        email: email,
        token: token,
        language: userLanguage, // ✅ RETURN LANGUAGE
        profile: user.profile
      }
    })
...
// ============================================================
// 📝 REGISTER - WITH LANGUAGE SUPPORT
// ============================================================
  ...
  try {
    ...
    const profile = {
      basics: {
        ...
        mobilePhone: phoneNumber || '',
        dob: dob || '',
        language: userLanguage // ✅ SAVE LANGUAGE
      },
      wizard: {
        startedAt: timestamp,
        lastUpdatedAt: timestamp,
