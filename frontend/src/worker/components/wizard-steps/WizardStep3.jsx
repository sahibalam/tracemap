...
// COMPONENT - WizardStep3 (Certifications & Requirements)
// ============================================================
export function WizardStep3({ data, onChange, onNext, onBack, onSkip }) {
  const { t } = useTranslation()
  ...
  // ✅ Check if any item is selected (for validation)
  const hasSelection = selectedCount > 0 || (isCivil && heavySelectedCount > 0)
  ...
  return (
    <div className="wizardStep">
          ...
          {isCivil && (
            <div style={{ marginBottom: '24px' }}>
              ...
              <div style={{
                ...
                {/* ✅ Responsive grid for heavy equipment types */}
                <div style={{
                  display: 'grid',
                  gridTemplateColumns: '1fr 1fr 1fr',
                  gap: '6px 16px',
              ...
              {sectionKeys.map((sectionKey) => {
                ...
                return (
                  <div key={sectionKey} style={{ marginBottom: '20px' }}>
                    ...
                    {/* ✅ Responsive grid for tools/certifications */}
                    <div style={{
                      display: 'grid',
                      gridTemplateColumns: '1fr 1fr 1fr',
                      gap: '6px 16px',
      ...
      <style>{`
        /* Mobile Responsive Styles for WizardStep3 */
        @media (max-width: 768px) {
          .wizardStep .wizardBody {
            padding: 12px !important;
          }

          /* Section grids - single column on mobile */
          .wizardStep .wizardSection div[style*="gridTemplateColumns: '1fr 1fr 1fr'"] {
            grid-template-columns: 1fr !important;
            gap: 4px 0 !important;
            padding: 10px 12px !important;
          }

          /* Heavy equipment section - single column on mobile */
          .wizardStep .wizardSection div[style*="gridTemplateColumns: '1fr 1fr 1fr'"] + div {
            grid-template-columns: 1fr !important;
            gap: 4px 0 !important;
          }
          ...
          /* Selected Trade Badge */
          .wizardStep .wizardSection div[style*="display: inline-block"] {
            font-size: 12px !important;
            padding: 3px 12px !important;
          }

          /* Section headers */
          .wizardStep .wizardSection div[style*="fontSize: 14px"] {
          ...
          /* Summary box */
          .wizardStep .wizardSection div[style*="padding: 12px 16px"][style*="background: rgba(47, 180, 99, 0.06)"] {
          ...
          /* No items message */
          .wizardStep .wizardSection div[style*="padding: 40px 20px"] {
        ...
        @media (max-width: 480px) {
          ...
          /* Checkbox labels - smaller on very small screens */
          .wizardStep .wizardSection label[style*="fontSize: 13px"] {
