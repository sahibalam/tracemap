...
//   // Navigation handlers
//   const handleEditBasic = () => {
//     navigate('/basic-info/edit', { state: { basicData: basics, parentData: profile } })
//   }

//   const handleEditTrade = () => {
//     navigate('/trade-profile/edit', { state: { tradeData: trade, parentData: profile } })
//   }

//   const handleEditWorkHistory = () => {
//     navigate('/work-history/edit', { state: { workHistoryData: workHistory, parentData: profile } })
//   }

//   const handleEditAvailability = () => {
//     navigate('/availability/edit', { state: { availabilityData: availability, parentData: profile } })
//   }

//   const handleEditCertifications = () => {
//     navigate('/certification/edit', { state: { certData: certifications, parentData: profile } })
//   }

//   const handleEditTax = () => {
//     navigate('/tax/edit', { state: { taxData: tax, parentData: profile } })
//   }

//   const handleEditPayment = () => {
//     navigate('/payment/edit', { state: { paymentData: payment, parentData: profile } })
//   }

//   const handleEditMedical = () => {
//     navigate('/medical/edit', { state: { medicalData: medical, parentData: profile } })
//   }

//   const handleEditEmergency = () => {
//     navigate('/emergency-contact/edit', { state: { emergencyData: emergency, parentData: profile } })
//   }
...
//           <div style={{ width: '40px', height: '40px', border: '3px solid rgba(15, 78, 169, 0.1)', borderTop: '3px solid #0f4ea9', borderRadius: '50%', animation: 'spin 1s linear infinite' }} />
//           <p style={{ color: '#17263a' }}>Loading profile...</p>
...
//         <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '80vh', flexDirection: 'column', gap: '16px' }}>
//           <p style={{ color: '#dc2626', fontSize: '16px' }}>❌ {error}</p>
//           <button onClick={() => navigate('/wizard')} style={{ padding: '10px 24px', background: '#0f4ea9', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer' }}>
//             Go to Wizard
//           </button>
//         </div>
//       </div>
...
//                 <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
//                   <span style={{ fontSize: '16px', fontWeight: 600, color: '#17263a' }}>Basic Information</span>
//                   <button onClick={handleEditBasic} style={{ background: 'none', border: 'none', color: '#0f4ea9', cursor: 'pointer', padding: '4px 8px', borderRadius: '6px', transition: 'background 0.2s' }}
//                     onMouseEnter={(e) => e.currentTarget.style.background = 'rgba(15, 78, 169, 0.08)'}
//                     onMouseLeave={(e) => e.currentTarget.style.background = 'transparent'}>
//                     <IconPencil />
//                   </button>
...
//                   </div>
//                   <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4px 16px' }}>
//                     <div><span style={{ fontSize: '12px', color: 'rgba(23,38,58,0.5)' }}>Date of Birth</span>
//                       <div style={{ fontSize: '14px', color: '#17263a' }}>{displayValue(basics.dob)}</div>
//                     </div>
//                     <div><span style={{ fontSize: '12px', color: 'rgba(23,38,58,0.5)' }}>Language</span>
//                       <div style={{ fontSize: '14px', color: '#17263a' }}>{language}</div>
//                     </div>
//                     <div><span style={{ fontSize: '12px', color: 'rgba(23,38,58,0.5)' }}>Email</span>
//                       <div style={{ fontSize: '14px', color: '#17263a' }}>{displayValue(basics.emailAddress)}</div>
//                     </div>
//                     <div><span style={{ fontSize: '12px', color: 'rgba(23,38,58,0.5)' }}>Phone No.</span>
//                       <div style={{ fontSize: '14px', color: '#17263a' }}>{formatPhone(basics.mobilePhone)}</div>
//                     </div>
//                     <div style={{ gridColumn: '1 / -1' }}><span style={{ fontSize: '12px', color: 'rgba(23,38,58,0.5)' }}>Address</span>
//                       <div style={{ fontSize: '14px', color: '#17263a' }}>{displayValue(address)}</div>
//                     </div>
//                   </div>
//                 </div>
...
//                 <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
//                   <span style={{ fontSize: '16px', fontWeight: 600, color: '#17263a' }}>Trade Profile</span>
//                   <button onClick={handleEditTrade} style={{ background: 'none', border: 'none', color: '#0f4ea9', cursor: 'pointer', padding: '4px 8px', borderRadius: '6px', transition: 'background 0.2s' }}
//                     onMouseEnter={(e) => e.currentTarget.style.background = 'rgba(15, 78, 169, 0.08)'}
//                     onMouseLeave={(e) => e.currentTarget.style.background = 'transparent'}>
//                     <IconPencil />
//                   </button>
...
//                 <div>
//                   <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4px 16px' }}>
//                     <div><span style={{ fontSize: '12px', color: 'rgba(23,38,58,0.5)' }}>Primary Trade</span>
//                       <div style={{ fontSize: '14px', color: '#17263a' }}>{displayValue(trade.primaryTrade)}</div>
//                     </div>
//                     <div><span style={{ fontSize: '12px', color: 'rgba(23,38,58,0.5)' }}>Secondary Trade</span>
//                       <div style={{ fontSize: '14px', color: '#17263a' }}>{displayValue(trade.secondaryTrade, '—')}</div>
//                     </div>
//                     <div style={{ gridColumn: '1 / -1' }}><span style={{ fontSize: '12px', color: 'rgba(23,38,58,0.5)' }}>Experience</span>
//                       <div style={{ fontSize: '14px', color: '#17263a' }}>{displayValue(trade.yearOfExperience)} years</div>
//                     </div>
//                   </div>
//                 </div>
...
//               <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
//                 <span style={{ fontSize: '16px', fontWeight: 600, color: '#17263a' }}>Work History</span>
//                 <button onClick={handleEditWorkHistory} style={{ background: 'none', border: 'none', color: '#0f4ea9', cursor: 'pointer', padding: '4px 8px', borderRadius: '6px', transition: 'background 0.2s' }}
//                   onMouseEnter={(e) => e.currentTarget.style.background = 'rgba(15, 78, 169, 0.08)'}
//                   onMouseLeave={(e) => e.currentTarget.style.background = 'transparent'}>
//                   <IconPencil />
//                 </button>
...
//                 <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
//                   <span style={{ fontSize: '16px', fontWeight: 600, color: '#17263a' }}>Availability & Rate</span>
//                   <button onClick={handleEditAvailability} style={{ background: 'none', border: 'none', color: '#0f4ea9', cursor: 'pointer', padding: '4px 8px', borderRadius: '6px', transition: 'background 0.2s' }}
//                     onMouseEnter={(e) => e.currentTarget.style.background = 'rgba(15, 78, 169, 0.08)'}
//                     onMouseLeave={(e) => e.currentTarget.style.background = 'transparent'}>
//                     <IconPencil />
//                   </button>
...
//                 <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
//                   <span style={{ fontSize: '16px', fontWeight: 600, color: '#17263a' }}>Certifications & Safety</span>
//                   <button onClick={handleEditCertifications} style={{ background: 'none', border: 'none', color: '#0f4ea9', cursor: 'pointer', padding: '4px 8px', borderRadius: '6px', transition: 'background 0.2s' }}
//                     onMouseEnter={(e) => e.currentTarget.style.background = 'rgba(15, 78, 169, 0.08)'}
//                     onMouseLeave={(e) => e.currentTarget.style.background = 'transparent'}>
//                     <IconPencil />
//                   </button>
...
//                 <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
//                   <span style={{ fontSize: '16px', fontWeight: 600, color: '#17263a' }}>Tax Profile</span>
//                   <button onClick={handleEditTax} style={{ background: 'none', border: 'none', color: '#0f4ea9', cursor: 'pointer', padding: '4px 8px', borderRadius: '6px', transition: 'background 0.2s' }}
//                     onMouseEnter={(e) => e.currentTarget.style.background = 'rgba(15, 78, 169, 0.08)'}
//                     onMouseLeave={(e) => e.currentTarget.style.background = 'transparent'}>
//                     <IconPencil />
//                   </button>
...
//                 <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
//                   <span style={{ fontSize: '16px', fontWeight: 600, color: '#17263a' }}>Payment / Bank Details</span>
//                   <button onClick={handleEditPayment} style={{ background: 'none', border: 'none', color: '#0f4ea9', cursor: 'pointer', padding: '4px 8px', borderRadius: '6px', transition: 'background 0.2s' }}
//                     onMouseEnter={(e) => e.currentTarget.style.background = 'rgba(15, 78, 169, 0.08)'}
//                     onMouseLeave={(e) => e.currentTarget.style.background = 'transparent'}>
//                     <IconPencil />
//                   </button>
...
//                 <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
//                   <span style={{ fontSize: '16px', fontWeight: 600, color: '#17263a' }}>Medical Details</span>
//                   <button onClick={handleEditMedical} style={{ background: 'none', border: 'none', color: '#0f4ea9', cursor: 'pointer', padding: '4px 8px', borderRadius: '6px', transition: 'background 0.2s' }}
//                     onMouseEnter={(e) => e.currentTarget.style.background = 'rgba(15, 78, 169, 0.08)'}
//                     onMouseLeave={(e) => e.currentTarget.style.background = 'transparent'}>
//                     <IconPencil />
//                   </button>
...
//                 <div>
//                   <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4px 16px' }}>
//                     <div><span style={{ fontSize: '12px', color: 'rgba(23,38,58,0.5)' }}>Blood Group</span>
//                       <div style={{ fontSize: '14px', color: '#17263a' }}>{displayValue(medical.bloodGroup)}</div>
//                     </div>
//                     <div><span style={{ fontSize: '12px', color: 'rgba(23,38,58,0.5)' }}>Allergies</span>
//                       <div style={{ fontSize: '14px', color: '#17263a' }}>{allergiesText}</div>
//                     </div>
//                   </div>
//                 </div>
...
//                 <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
//                   <span style={{ fontSize: '16px', fontWeight: 600, color: '#17263a' }}>Emergency Contact</span>
//                   <button onClick={handleEditEmergency} style={{ background: 'none', border: 'none', color: '#0f4ea9', cursor: 'pointer', padding: '4px 8px', borderRadius: '6px', transition: 'background 0.2s' }}
//                     onMouseEnter={(e) => e.currentTarget.style.background = 'rgba(15, 78, 169, 0.08)'}
//                     onMouseLeave={(e) => e.currentTarget.style.background = 'transparent'}>
//                     <IconPencil />
//                   </button>
...
//                 <div>
//                   <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '4px 16px' }}>
//                     <div><span style={{ fontSize: '12px', color: 'rgba(23,38,58,0.5)' }}>Name</span>
//                       <div style={{ fontSize: '14px', color: '#17263a' }}>{displayValue(emergency.emergencyContactName)}</div>
//                     </div>
//                     <div><span style={{ fontSize: '12px', color: 'rgba(23,38,58,0.5)' }}>Relationship</span>
//                       <div style={{ fontSize: '14px', color: '#17263a' }}>{displayValue(emergency.emergencyContactRelationship)}</div>
//                     </div>
//                     <div><span style={{ fontSize: '12px', color: 'rgba(23,38,58,0.5)' }}>Phone</span>
//                       <div style={{ fontSize: '14px', color: '#17263a' }}>{formatPhone(emergency.emergencyContactPhone)}</div>
//                     </div>
//                   </div>
//                 </div>
...
//                           marginTop: '4px',
//                         }}>
//                           + {tradeRows.length - 2} more trade{tradeRows.length - 2 > 1 ? 's' : ''}
//                         </div>
//                       )}
