...
//               {/* ============================================================
//               ❌ TAX PROFILE CARD - COMMENTED OUT
//               ============================================================ */}
//               {/* 
//               <div className="wizardSummaryCard" style={{ padding: '20px', border: '1px solid rgba(18,38,63,0.08)', borderRadius: '12px', background: 'white' }}>
//                 <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
...
//                           return (
//                             <div key={tradeData.trade} style={{ marginBottom: index < tradesWithSkillGroups.length - 1 ? '10px' : '0' }}>
//                               {/* Trade header - clickable to expand */}
//                               <div 
//                                 style={{
//                                   display: 'flex',
...
//                                 </div>
//                                 {isExpanded ? (
//                                   <IconChevronDown style={{ width: '12px', height: '12px', color: 'rgba(23,38,58,0.4)' }} />
//                                 ) : (
//                                   <IconChevronRight style={{ width: '12px', height: '12px', color: 'rgba(23,38,58,0.4)' }} />
//                                 )}
//                               </div>
...
//                         {/* Tools & Certifications Summary */}
//                         {totalToolsCount > 0 && (
//                           <div style={{ marginTop: '10px', paddingTop: '8px', borderTop: '1px solid rgba(18,38,63,0.06)' }}>
//                             <div 
//                               style={{ 
//                                 display: 'flex', 
//                                 alignItems: 'center', 
...
//                                 gap: '4px'
//                               }}>
//                                 <IconWrench style={{ color: 'rgba(23,38,58,0.4)', width: '10px', height: '10px' }} />
//                                 {t('wizard.step3.toolsCertifications')}
//                                 <span style={{
//                                   fontSize: '10px',
//                                   color: selectedToolsCount === totalToolsCount ? '#2fb463' : '#0f4ea9',
...
//                                         gap: '2px'
//                                       }}>
//                                         <IconCheck style={{ width: '8px', height: '8px' }} />
//                                         {tool}
//                                       </span>
//                                     ))}
//                                   {Object.keys(toolsCertifications).filter(key => toolsCertifications[key] === true).length > 6 && (
//                                     <span style={{
//                                       fontSize: '10px',
//                                       color: 'rgba(23,38,58,0.5)',
//                                       padding: '1px 6px',
//                                     }}>
//                                       +{Object.keys(toolsCertifications).filter(key => toolsCertifications[key] === true).length - 6} more
//                                     </span>
//                                   )}
//                                 </div>
//                               </div>
...
//                                     </span>
//                                   ))}
//                                 {Object.keys(heavyEquipment).filter(key => heavyEquipment[key] === true).length > 3 && (
//                                   <span style={{
//                                     fontSize: '9px',
//                                     color: 'rgba(23,38,58,0.5)',
//                                     padding: '1px 6px',
...
//                       </>
//                     ) : (
//                       <div style={{ color: 'rgba(23,38,58,0.4)', fontSize: '12px', textAlign: 'center', padding: '10px 0' }}>
//                         {t('summary.noTradeInfo')}
//                       </div>
//                     )}
//                   </div>
...
//                       </div>
//                     </div>
//                     <div style={{ marginTop: '10px', padding: '10px', background: 'rgba(15,78,169,0.06)', borderRadius: '8px', textAlign: 'center' }}>
//                       <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }}>
//                         <IconTrophy style={{ color: '#f59e0b', width: '16px', height: '16px' }} />
//                         <span style={{ fontSize: '18px', fontWeight: 700, color: '#0f4ea9' }}>12</span>
//                         <span style={{ fontSize: '11px', color: 'rgba(23,38,58,0.6)' }}>{t('summary.tradePoints')}</span>
//                       </div>
//                     </div>
//                   </div>
//                 </div>
...
//             {/* ============================================================
//             ONE SINGLE CARD with ALL SECTIONS
//             ============================================================ */}
//             <div style={{
//               background: 'white',
//               borderRadius: '16px',
...
//               {/* ============================================================
//               ROW 1: Basic Information, Trade Profile, Subscription
//               ============================================================ */}
//               <div style={{
//                 display: 'grid',
//                 gridTemplateColumns: '1fr 1fr 1fr',
...
//                 marginBottom: '24px',
//                 paddingBottom: '24px',
//                 borderBottom: '1px dashed rgba(15, 78, 169, 0.2)',
//               }}>
...
//               ROW 2: Work History
//               ============================================================ */}
//               <div style={{ marginBottom: '24px', paddingBottom: '24px', borderBottom: '1px dashed rgba(15, 78, 169, 0.2)' }}>
//                 <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
//                   <span style={{ fontSize: '16px', fontWeight: 600, color: '#17263a' }}>{t('summary.workHistory')}</span>
//                   <button 
//                     type="button" 
...
//                     <span style={{ fontSize: '14px', fontWeight: 600, color: '#17263a' }}>{t('summary.availabilityRate')}</span>
//                     <button 
//                       type="button" 
//                       onClick={handleEditAvailability}
//                       style={{ 
...
//                 <div style={{ padding: '16px', border: '1px solid rgba(18,38,63,0.08)', borderRadius: '12px', background: 'white' }}>
//                   <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
//                     <span style={{ fontSize: '14px', fontWeight: 600, color: '#17263a' }}>{t('summary.certifications')}</span>
//                     <button 
//                       type="button" 
//                       onClick={handleEditCertifications}
//                       style={{ 
...
//                 <div style={{ padding: '16px', border: '1px solid rgba(18,38,63,0.08)', borderRadius: '12px', background: 'white' }}>
//                   <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
//                     <span style={{ fontSize: '14px', fontWeight: 600, color: '#17263a' }}>{t('summary.paymentDetails')}</span>
//                     <button 
//                       type="button" 
//                       onClick={handleEditPayment}
//                       style={{ 
...
//                 <div style={{ padding: '16px', border: '1px solid rgba(18,38,63,0.08)', borderRadius: '12px', background: 'white' }}>
//                   <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
//                     <span style={{ fontSize: '14px', fontWeight: 600, color: '#17263a' }}>{t('summary.medicalDetails')}</span>
//                     <button 
//                       type="button" 
//                       onClick={handleEditMedical}
//                       style={{ 
...
//                       <div>
//                         <span style={{ fontSize: '12px', color: 'rgba(23,38,58,0.5)' }}>{t('summary.bloodGroup')}</span>
//                         <div style={{ fontSize: '13px', color: '#17263a' }}>{displayValue(medical.bloodGroup)}</div>
//                       </div>
//                       <div>
//                         <span style={{ fontSize: '12px', color: 'rgba(23,38,58,0.5)' }}>{t('summary.allergies')}</span>
//                         <div style={{ fontSize: '13px', color: '#17263a' }}>{allergiesText}</div>
//                       </div>
//                     </div>
//                   </div>
//                 </div>
...
//                 <div style={{ padding: '16px', border: '1px solid rgba(18,38,63,0.08)', borderRadius: '12px', background: 'white' }}>
//                   <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
//                     <span style={{ fontSize: '14px', fontWeight: 600, color: '#17263a' }}>{t('summary.emergencyContact')}</span>
//                     <button 
//                       type="button" 
//                       onClick={handleEditEmergency}
//                       style={{ 
...
//                       <div>
//                         <span style={{ fontSize: '12px', color: 'rgba(23,38,58,0.5)' }}>{t('summary.name')}</span>
//                         <div style={{ fontSize: '13px', color: '#17263a' }}>{displayValue(emergency.emergencyContactName)}</div>
//                       </div>
//                       <div>
//                         <span style={{ fontSize: '12px', color: 'rgba(23,38,58,0.5)' }}>{t('summary.relationship')}</span>
//                         <div style={{ fontSize: '13px', color: '#17263a' }}>{displayValue(emergency.emergencyContactRelationship)}</div>
//                       </div>
//                       <div>
//                         <span style={{ fontSize: '12px', color: 'rgba(23,38,58,0.5)' }}>{t('summary.phone')}</span>
//                         <div style={{ fontSize: '13px', color: '#17263a' }}>{formatPhone(emergency.emergencyContactPhone)}</div>
//                       </div>
//                     </div>
//                   </div>
//                 </div>
...
//             {/* ============================================================
//             ONE SINGLE CARD with ALL SECTIONS - DROP SHADOW, NO DOTTED BORDER
//             ============================================================ */}
//             <div style={{
//               background: 'white',
//               borderRadius: '16px',
...
//                 <div style={{
//                   paddingRight: '20px',
//                   borderRight: '1px solid rgba(18, 38, 63, 0.08)',
//                 }}>
//                   <div style={{
//                     display: 'flex',
//                     justifyContent: 'space-between',
...
// ✅ Mobile Sidebar Content Component - Rendered inside hamburger menu on mobile
...
export function WorkerSummaryPage() {
  ...
  return (
    <div className="appShell">
      {/* ✅ Pass mobileMenuContent to TopNav for hamburger menu on mobile */}
      ...
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          /* ROW 1: Basic Info, Trade, Subscription - stack on mobile */
          .wizardSummaryPage > div > div:first-child {
            display: grid !important;
            grid-template-columns: 1fr !important;
            gap: 20px !important;
            border-bottom: 1px solid rgba(18, 38, 63, 0.08) !important;
          }

          /* Remove borders between sections */
          .wizardSummaryPage > div > div:first-child > div {
            padding: 0 !important;
          ...
          .wizardSummaryPage > div > div:first-child > div:last-child {
            border-bottom: none !important;
            padding-bottom: 0 !important;
          }

          /* Basic Info - profile image smaller */
          ...
          .wizardSummaryPage div[style*="gridTemplateColumns: '1fr 1fr'"] {
            grid-template-columns: 1fr !important;
            gap: 4px 0 !important;
          }

          /* Trade Profile - skills list more compact */
          .wizardSummaryPage div[style*="padding: 6px 8px"] {
            padding: 4px 6px !important;
          }

          .wizardSummaryPage div[style*="padding: 3px 0"] {
          ...
          .wizardSummaryPage > div > div:nth-child(3) {
            display: grid !important;
          ...
          .wizardSummaryPage > div > div:nth-child(3) > div {
            padding: 12px !important;
          }

          /* ROW 4: Medical & Emergency - stack on mobile */
          .wizardSummaryPage > div > div:last-child {
            display: grid !important;
            grid-template-columns: 1fr !important;
            gap: 12px !important;
          }

          /* Emergency contact grid - 1 column on mobile */
          .wizardSummaryPage div[style*="gridTemplateColumns: '1fr 1fr 1fr'"] {
            grid-template-columns: 1fr !important;
            gap: 4px 0 !important;
          }

          /* Medical details grid - 1 column on mobile */
          .wizardSummaryPage div[style*="gridTemplateColumns: '1fr 1fr'"] {
            grid-template-columns: 1fr !important;
            gap: 4px 0 !important;
          }

          /* All labels - smaller on mobile */
          .wizardSummaryPage span[style*="fontSize: 10px"] {
            font-size: 9px !important;
          }

          .wizardSummaryPage div[style*="fontSize: 13px"] {
            font-size: 12px !important;
          }

          .wizardSummaryPage div[style*="fontSize: 14px"] {
            font-size: 13px !important;
          }

          .wizardSummaryPage .project-title {
            font-size: 13px !important;
          }

          /* Subscription points - smaller */
          .wizardSummaryPage div[style*="fontSize: 18px"] {
            font-size: 16px !important;
          }

          /* Certifications tags - wrap better */
          .wizardSummaryPage div[style*="padding: 6px 10px"] {
            padding: 4px 8px !important;
            font-size: 10px !important;
          }

          .wizardSummaryPage span[style*="fontSize: 10px"][style*="border: 1px solid rgba(47, 180, 99, 0.1)"] {
            font-size: 9px !important;
            padding: 1px 6px !important;
          }

          /* No projects message */
          .wizardSummaryPage div[style*="padding: 40px 20px"] {
            padding: 24px 16px !important;
            font-size: 13px !important;
          }

          .wizardSummaryPage div[style*="fontSize: 40px"] {
        ...
        @media (max-width: 480px) {
          ...
          /* ROW 3: 1 column on very small screens */
          .wizardSummaryPage > div > div:nth-child(3) {
            grid-template-columns: 1fr !important;
            gap: 10px !important;
          }

          /* Basic info - profile image even smaller */
          .wizardSummaryPage img[style*="width: 40px"][style*="height: 40px"] {
