...
// // Read-only TextField component for email and phone
// function ReadOnlyField({ placeholder, icon, value }) {
//   return (
//     <div style={{
//       display: 'flex',
//       alignItems: 'center',
    ...
    <div className="appShell">
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ marginBottom: '24px' }}>
                  ...
                  <div className="basic-info-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                    <TextField 
                      placeholder={t('auth.firstName')} 
                      icon={<IconUser />} 
                      value={basicData.legalFirstName || ''} 
                ...
                {/* Address + Current Address */}
                <div style={{ marginBottom: '24px' }}>
                  <div className="address-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                    {/* Address */}
                    <div>
                      <div style={{
                        fontSize: '14px',
      ...
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .appContent > div[style*="padding: 24px"] {
            padding: 12px !important;
          }

          /* Basic info grid - 1 column on mobile */
          .basic-info-grid {
            grid-template-columns: 1fr !important;
            gap: 10px !important;
          }

          /* Address grid - 1 column on mobile */
          .address-grid {
            grid-template-columns: 1fr !important;
            gap: 16px !important;
          }
          ...
          .address-grid div[style*="display: flex"][style*="gap: 10px"] {
            flex-direction: column !important;
            gap: 8px !important;
          }

          .address-grid div[style*="display: flex"][style*="gap: 10px"] > div,
          .address-grid div[style*="display: flex"][style*="gap: 10px"] > [style*="flex: 1"] {
            flex: 1 1 100% !important;
            width: 100% !important;
          }

          /* Details grid - 1 column on mobile */
          .details-grid {
            grid-template-columns: 1fr !important;
            gap: 16px !important;
          }

          /* Languages - wrap better on mobile */
          .details-grid div[style*="display: flex"][style*="gap: 20px"] {
            gap: 12px !important;
          }

          .details-grid div[style*="display: flex"][style*="gap: 20px"] label {
            font-size: 13px !important;
          }

          /* Profile image - smaller on mobile */
          .wizardSummaryPage div[style*="width: 80px"][style*="height: 80px"] {
            width: 60px !important;
            height: 60px !important;
          }

          /* Upload button - full width on mobile */
          .wizardSummaryPage button[onClick*="uploadRef"] {
            width: 100% !important;
            justify-content: center !important;
          }

          /* Form card - reduce padding on mobile */
          .appContent > div > div[style*="background: white"][style*="padding: 32px"] {
            padding: 16px !important;
          }

          /* Section headers - smaller on mobile */
          .appContent > div > div[style*="background: white"][style*="padding: 32px"] div[style*="font-size: 16px"] {
            font-size: 14px !important;
          }

          /* Read-only fields - smaller on mobile */
          .appContent .read-only-field {
            height: 38px !important;
          }

          .appContent .read-only-field input {
            font-size: 12px !important;
          }

          /* Footer buttons - stack on mobile */
          .appContent > div > div:last-child {
            flex-direction: column !important;
            gap: 10px !important;
          }

          .appContent > div > div:last-child button {
            width: 100% !important;
            justify-content: center !important;
          }

          /* Date picker input - smaller on mobile */
          .date-picker-wrapper .react-datepicker__input-container input {
            height: 34px !important;
            font-size: 12px !important;
          }

          /* State dropdown - smaller on mobile */
          .basic-info-edit .state-dropdown {
            height: 34px !important;
            font-size: 12px !important;
          }

          /* TextField inputs - smaller on mobile */
        ...
        @media (max-width: 480px) {
          ...
          /* Languages - full width on small screens */
          .details-grid div[style*="display: flex"][style*="gap: 20px"] {
            flex-direction: column !important;
            gap: 6px !important;
          }
          ...
          /* Section headers */
          .appContent > div > div[style*="background: white"][style*="padding: 32px"] div[style*="font-weight: 600"] {
            font-size: 12px !important;
          }
        }
