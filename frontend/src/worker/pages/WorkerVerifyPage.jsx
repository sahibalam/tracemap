...
export function WorkerVerifyPage() {
  ...
  // ============================================================
  // SIDEBAR MENU ITEMS (will be shown in hamburger drawer)
  // ============================================================
  const sidebarItems = [
    { label: 'Overview', icon: 'overview', disabled: true },
    { label: 'Projects', icon: 'projects', disabled: true, badge: '12' },
    { label: 'Revenues', icon: 'revenues', disabled: true },
    { label: 'Profile', icon: 'profile', active: true },
  ]

  const sidebarBottomItems = [
    { label: 'Sign out', icon: 'logout', action: () => navigate('/login') },
    { label: 'Support', icon: 'support', disabled: true },
  ]
  ...
  return (
    <div className="appShell">
      ...
      <style>{`
        ...
        /* ✅ Mobile: Hide sidebar, it's inside hamburger menu */
        @media (max-width: 768px) {
          .sideNav {
