...
const datePickerStyles = `
  .tax-date-picker .react-datepicker__input-container input {
    width: 100%;
    height: 48px;
    padding: 0 12px;
    padding-right: 36px;
  ...
  .tax-date-picker .react-datepicker__input-container input:hover {
    border-color: rgba(15, 78, 169, 0.4);
  }

  .tax-date-picker .react-datepicker__input-container input:focus {
    border-color: #0f4ea9;
    box-shadow: 0 0 0 3px rgba(15, 78, 169, 0.1);
  }

  .tax-date-picker .react-datepicker__input-container input::placeholder {
    color: rgba(23, 38, 58, 0.4);
  }

  .tax-date-picker .react-datepicker {
    font-family: inherit;
    border-radius: 12px;
    border: 1px solid rgba(18, 38, 63, 0.08);
  ...
  .tax-date-picker .react-datepicker__header {
    background: white;
  ...
  .tax-date-picker .react-datepicker__current-month {
    color: #17263a;
    font-weight: 700;
    font-size: 14px;
    padding-bottom: 4px;
  ...
  .tax-date-picker .react-datepicker__day-name {
  ...
  .tax-date-picker .react-datepicker__day {
    width: 32px;
    height: 32px;
    line-height: 32px;
    margin: 2px;
  ...
  .tax-date-picker .react-datepicker__day:hover {
    background: rgba(15, 78, 169, 0.08);
    border-radius: 8px;
  }

  .tax-date-picker .react-datepicker__day--selected {
  ...
  .tax-date-picker .react-datepicker__day--selected:hover {
    background: #0b3f90 !important;
  }

  .tax-date-picker .react-datepicker__day--keyboard-selected {
    background: rgba(15, 78, 169, 0.15);
    border-radius: 8px;
  }

  .tax-date-picker .react-datepicker__day--today {
    font-weight: 700;
    color: #0f4ea9;
  }

  .tax-date-picker .react-datepicker__day--today::after {
    content: '';
    display: block;
    width: 4px;
    height: 4px;
  ...
  .tax-date-picker .react-datepicker__day--disabled {
    color: rgba(23, 38, 58, 0.2);
    cursor: not-allowed;
  }

  .tax-date-picker .react-datepicker__day--disabled:hover {
    background: transparent;
  }

  .tax-date-picker .react-datepicker__day--outside-month {
    color: rgba(23, 38, 58, 0.2);
  }

  .tax-date-picker .react-datepicker__navigation {
    top: 12px;
    background: transparent;
    border: none;
    cursor: pointer;
  ...
  .tax-date-picker .react-datepicker__navigation:hover {
    background: rgba(15, 78, 169, 0.08);
  }

  .tax-date-picker .react-datepicker__navigation-icon::before {
    border-color: #17263a;
  ...
  .tax-date-picker .react-datepicker__day--weekend {
    color: #e11d48;
  }

  .tax-date-picker .react-datepicker__day--weekend.react-datepicker__day--selected {
    color: white;
  }

  .tax-date-picker .react-datepicker__input-container {
    position: relative;
    width: 100%;
  }

  .tax-date-picker .react-datepicker-wrapper {
    width: 100%;
  }

  .tax-date-picker .react-datepicker__input-container::after {
    content: '📅';
    position: absolute;
    right: 12px;
    top: 50%;
  ...
  .tax-date-picker .react-datepicker-popper {
...
export function TaxEditPage() {
  ...
  const handleDateChange = (date) => {
    if (date) {
      ...
      handleChange('employeeStartDate', `${month}/${day}/${year}`)
    } else {
      handleChange('employeeStartDate', '')
    }
  }
                ...
                {taxData.classificationPath === 'employee' && (
                  <div style={{ marginBottom: '24px' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '12px', marginBottom: '12px' }}>
                      ...
                      {/* ✅ REPLACED with DatePicker */}
                      <div className="tax-date-picker" style={{ position: 'relative' }}>
                        <DatePicker
                          selected={parseDate(taxData.employeeStartDate)}
