...
//   // ✅ Email update fields (NO CURRENT PASSWORD REQUIRED)
...
//   // ✅ Send email verification code (NO CURRENT PASSWORD REQUIRED)
...
//     try {
//       // ✅ Removed currentPassword from the request
...
//           userId,
//           currentPassword: '', // Not needed for password change via this flow
//           newPassword
//         })
...
//                   {/* ✅ EMAIL ADDRESS - WITHOUT CURRENT PASSWORD REQUIREMENT */}
...
export function AccountSettingsPage() {
  ...
  const checkPhoneAvailabilityRealTime = async (phoneToCheck) => {
    ...
    try {
      // Check if phone exists in Workers table
      const result = await api.get(`/worker/phone/${digitsOnly}`)
