...
//             if (data.toolsCertifications) setToolsCertifications(data.toolsCertifications)
//             if (data.heavyEquipment) setHeavyEquipment(data.heavyEquipment)
//             setLoading(false)
//             return
//           }
          
//           // ✅ If tradeData exists but has no tradeRows, don't use it - fetch from API instead
//           // This prevents empty tradeData from overriding API data
...
//     setTradeRows([createInitialTradeRow(), ...tradeRows])
//   }
// }
...
//                         const sections = getToolSections(trade)
...
// ============================================================
// TOOLS_CERTIFICATIONS
// ============================================================
const TOOLS_CERTIFICATIONS = {
  // ... (keep your existing TOOLS_CERTIFICATIONS data here - it's too long to reprint)
  // The data structure is the same as in your original code
}

// ============================================================
// HEAVY_EQUIPMENT_TYPES & HEAVY_EQUIPMENT_TASKS
// ============================================================
const HEAVY_EQUIPMENT_TYPES = [
  'Skid Steer',
  'Mini Excavator',
