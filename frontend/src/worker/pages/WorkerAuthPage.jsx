...
export function WorkerAuthPage({ initialMode = 'login' }) {
  ...
  const validateRegistration = () => {
    ...
    // ✅ Email - Required (already handled)
    if (!email || emailError) {
      isValid = false
    }
  ...
  const handleRegister = async (e) => {
    ...
    if (!isValid) {
      ...
      const firstError = document.querySelector('.email-error, .dob-error, .field-error')
      if (firstError) {
            ...
            {mode === 'login' ? (
              ...
              <>
                ...
                <div className="formGrid2">
                  ...
                  <div>
                    <div className={`phone-field-container ${phoneError ? 'phone-field-container-error' : ''}`}>
                      <span className="phone-country-code">+1</span>
                      <input 
                        type="tel" 
                        placeholder="555-555-5555" 
                        value={phoneNumber}
