                  ...
                  {userTrades.length > 0 ? (
                    <div>
                      {userTrades.map((trade) => {
                        const tradeCerts = getCertificationsForTrade(trade)
                        const isExpanded = expandedSections[trade] || false
                        const checkedForTrade = tradeCerts.filter(cert => certData.certChecklist?.[cert] === true).length
                            ...
                            >
                              <div style={{
                                ...
                                <span style={{
                                  ...
                                  {tradeCerts.length} certifications
                                </span>
                                {checkedForTrade > 0 && (
                                  <span style={{
                                    fontSize: '11px',
