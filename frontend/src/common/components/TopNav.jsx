...
//       console.log('👤 TopNav: User name set to', `${firstName} ${lastName}`.trim())
//     }
//   }
...
import { LanguageSwitcher } from './LanguageSwitcher'
import api from '../../services/api'
import { AccountSettingsModal } from './AccountSettingsModal' // ✅ NEW: Import the modal
...
export function TopNav({ variant = 'solid', hideNav = false }) {
  ...
  // ✅ NEW: State for Account Settings Modal
  ...
  // ... (keep all your existing code up to the dropdown section)

  // ✅ NEW: Handle Account Settings click
  ...
  return (
    <>
      ...
      <nav className={`topnav ${isAuthPage && variant === 'auth' ? 'topnav-hidden' : ''}`}>
        ...
        {/* Dropdown Menu - Add Account Settings */}
        {isDropdownOpen && (
          <div
            ref={dropdownRef}
            className="topnav-dropdown"
