...
//           /* ✅ Mobile Sign In Link with User Icon */
//           .topnav-mobile-signin {
//             display: none;
//             align-items: center;
//             gap: 6px;
//             background: none;
...
//           .topnav-mobile-signin:hover {
//             background: rgba(15, 78, 169, 0.06);
//           }

//           .topnav-mobile-signin svg {
//             width: 18px;
//             height: 18px;
//           }
...
//           /* ============================================================
//              ✅ MOBILE RESPONSIVE - MATCHES ATTACHMENT
//              ============================================================ */
...
//           {/* Right: Login/Sign In OR User Avatar */}
//           <div className="topnav-right">
//             {!isAuthenticated ? (
//               <>
...
//                 {/* ✅ Mobile Sign In Link with User Icon - matches attachment */}
//                 <button 
//                   className="topnav-mobile-signin"
//                   onClick={() => navigate('/login')}
//                 >
//                   <IconUser />
//                   <span>Sign In</span>
...
// export function TopNav({ variant = 'solid', hideNav = false, mobileMenuContent }) {
//   const { t } = useTranslation()
//   const navigate = useNavigate()
//   const location = useLocation()
//   const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false)
...
//           .topnav-mobile-sidebar .sideGroupLabel {
...
//           .topnav-mobile-sidebar .sideGroup {
//             display: grid;
//             gap: 8px;
//             padding: 0 6px;
//           }

//           .topnav-mobile-sidebar .sideItem {
//             display: grid;
...
//           .topnav-mobile-sidebar .sideItem:hover {
//             background: rgba(15, 23, 42, 0.04);
//           }

//           .topnav-mobile-sidebar .sideItemActive {
//             color: rgba(255, 255, 255, 0.96);
//             background: linear-gradient(180deg, #0f4ea9 0%, #0b3f90 100%);
//             box-shadow: 0 12px 26px rgba(15, 78, 169, 0.25);
//           }

//           .topnav-mobile-sidebar .sideItemActive .sideIcon {
//             color: rgba(255, 255, 255, 0.96);
//           }

//           .topnav-mobile-sidebar .sideItemDisabled {
//             opacity: 0.45;
//             cursor: not-allowed;
//           }

//           .topnav-mobile-sidebar .sideItemDisabled:hover {
//             background: transparent;
//           }

//           .topnav-mobile-sidebar .sideIcon {
...
//           .topnav-mobile-sidebar .sideBadge {
//             font-size: 12px;
//             font-weight: 900;
//             padding: 4px 10px;
//             border-radius: 999px;
...
//           .topnav-mobile-sidebar .sideItemButton {
//             cursor: pointer;
//           }
...
//         {/* Mobile Menu */}
//         <div className={`topnav-mobile-menu ${isMobileMenuOpen ? 'open' : ''}`} ref={menuRef}>
//           {/* ✅ Render custom mobile menu content if provided */}
//           {mobileMenuContent ? (
//             <div className="topnav-mobile-sidebar">
//               {mobileMenuContent}
//             </div>
//           ) : (
//             <>
    ...
    <>
      <style>
        {`
          ...
          /* ✅ Mobile Menu Overlay - Fix for closing */
      ...
      <nav className="topnav">
        ...
        {/* ✅ Mobile Menu with Overlay for better closing */}
        <div 
