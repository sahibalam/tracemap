...
// ============================================================
// 📱 MOBILE SIDEBAR CONTENT (Same as worker module)
// ============================================================
function MobileSidebarContent() {
  return (
    <>
...
// ============================================================
// 📊 STATS CARDS - EXACT MATCH FROM ATTACHMENT
// ============================================================
...
// ============================================================
// ⚡ QUICK ACTIONS - EXACT MATCH (Vertical Cards)
// ============================================================
function QuickActions() {
  const actions = [
    'Create New Project',
        ...
        {actions.map((action, idx) => (
          <button
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.borderColor = 'rgba(15, 78, 169, 0.12)'
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.background = 'white'
              e.currentTarget.style.borderColor = 'rgba(18,38,63,0.06)'
...
// ============================================================
// 👷 WORKFORCE OVERVIEW - EXACT MATCH (Progress Bars)
// ============================================================
function WorkforceOverview() {
  const data = [
    { status: 'On Site', count: 92, percentage: 59, color: '#0f4ea9' },
